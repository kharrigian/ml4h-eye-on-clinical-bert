...
CUDA_VISIBLE_DEVICES="1" python -u scripts/model/pretrain.py \
    --setting train \
    --model_dir "./data/models/pretraining/synthetic-wnut_2017/bert-base-cased-cpt/" \
...
python -u scripts/model/pretrain.py \
    --setting plot \
    --model_dir "./data/models/pretraining/synthetic-wnut_2017/continued/bert-base-cased-cpt/" \
    --plot_prop 1.0
